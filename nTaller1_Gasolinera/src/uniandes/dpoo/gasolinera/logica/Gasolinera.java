...
public class Gasolinera
{
     ...
     */
    public int venderGasolinaPorCantidad( String nombreTipoGasolina, double cantidadDeseada, int numeroSurtidor )
    {
        ...
        try
        {
            ...
            tipo.despacharGasolina( cantidadDeseada );
            cantidadEntregada = cantidadDeseada;
        }
     ...
     */
    public int venderGasolinaPorPrecio( String nombreTipoGasolina, int precioDeseado, int numeroSurtidor )
    {
        TipoGasolina tipo = tiposGasolina.get( nombreTipoGasolina );
        double cantidadSolicitada = precioDeseado / ( double )tipo.getPrecioPorGalon( );
